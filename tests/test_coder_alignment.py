...
def test_add_derived_columns(sample_data_and_config):
    ...
    print("----------------------")
    #print(analyzer.df['is_correct'].tolist())
    ...
    print(analyzer.df['is_correct_2_digit'].tolist())
...
def test_get_jaccard_similarity(sample_data_and_config):
    ...
    print(analyzer.df['is_correct'].tolist())
    print(analyzer.df['is_correct_2_digit'].tolist())
    print('analyzer.get_jaccard_similarity()', analyzer.get_jaccard_similarity())
...
def test_get_candidate_contribution(sample_data_and_config):
    ...
    print(result['total_predictions_made'])
    print(result['primary_match_count'])
    print(result['any_clerical_match_count'])
    print(result['any_clerical_match_percent'])
